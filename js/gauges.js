...
function () {
    ...
    var strings = LANG.EN,         //Set to your default language. Store all the strings in one object
        ...
        gaugeGlobals = {
            ...
            background            : steelseries.BackgroundColor.MUD,
            foreground            : steelseries.ForegroundType.TYPE2,
            pointer               : steelseries.PointerType.TYPE16,
            pointerColour         : steelseries.ColorDef.WHITE,
        ...
        programLink =  ['<a href="https://cumuluswiki.org/a/Software" target="_blank">Cumulus MX</a>',
