...
$WunderWrong = true;
//
$timezone   = "Australia/Sydney";                    // Change to your TZ.  Ken True has a list available at http://saratoga-weather.org/timezone.txt
$WUID       = "I90580966";                          // Your stations Wunderground ID
...
$header     = false;                                 // true if you wish to use it
$Langtitle  = "Latham-Weather Station Historical Data";            // The Bold text at the top
$LcurDay    = "Return to Current Day";              // The link back to the current day if off in one of the other modes.  "" to disable it.
// Optional footer bar
$footer     = false;                                 // true if you wish to have the colored footer bar at the bottom
$LangFtext  = "Latham Weather";              // Anything you wish or "" for a plain bar
